    ...
    return Dialog(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Text(getTranslated('want_to_sign_out', context)!, style: cairoBold, textAlign: TextAlign.center),
        ),
        ...
        Row(children: [
          ...
          Expanded(child: InkWell(
            ...
            child: Container(
              ...
              child: Text(getTranslated('YES', context)!, style: cairoBold.copyWith(color: Theme.of(context).primaryColor)),
            ),
          )),
          ...
          Expanded(child: InkWell(
            ...
            child: Container(
              ...
              child: Text(getTranslated('NO', context)!, style: cairoBold.copyWith(color: ColorResources.WHITE)),
            ),
          )),
