...
class ProductVariants extends StatelessWidget {
  final DetailsProductModel details;
  ProductVariants({required this.details});
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                    children: (Provider.of<LocalizationProvider>(context).locale!.languageCode == "en"
                        ? details.fetchedProductSizeEN!
                        : details.fetchedProductSize!)[key]!.map((item) => Padding(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                children: [
                                  Text(item.color == null || item.color!.isEmpty
                                      ? " "
                                      : item.color.toString(),
                                      style: cairoBold.copyWith(color: ColorResources.BLACK)),
