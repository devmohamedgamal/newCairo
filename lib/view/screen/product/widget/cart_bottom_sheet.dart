            ...
            child: Consumer<ProductProvider>(
              builder: (context, details, child) {
                return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Align(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          width: 25,
                          height: 25,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: Theme.of(context).highlightColor, boxShadow: [
                            BoxShadow(
                  ...
                  Row(children: [
                    Container(
                      ...
                      child: FadeInImage.assetNetwork(
                        ...
                        image: '${AppConstants.BASE_URL_IMAGE}${widget.product.pavatar}',
                  ...
                  // Quantity
                  Row(children: [
                    Text(getTranslated('quantity', context)!, style: cairoBold),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            key.contains("#")
                                                ? Row(
                                                    children: [
                                                      Text(getTranslated("color_variants", context)! + key.toString(), style: cairoBold),
                                                      Container(
                                                        width: 25,
                                                        height: 25,
                                                        ...
                                                        child: Center(
                                                          child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  ...
                                                                  color: Color(int.parse("0xfff${key.toString().replaceAll("#", "")}")))),
                                                        ),
                                                      )
                                                    ],
                                                  )
                                                : Text(getTranslated("variants", context)! + key.toString(),
                                                    textAlign: TextAlign.right, style: cairoBold),
                                            Column(
                                                children: (Provider.of<LocalizationProvider>(context).locale!.languageCode == "en"
                                                        ? details.detailsProduct!.fetchedProductSizeEN!
                                                        : details.detailsProduct!.fetchedProductSize!)[key]!
                                                    .map(
                                                      (item) => Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                              borderRadius: BorderRadius.circular(0), color: Colors.black.withOpacity(0.05)),
                                                          child: CheckboxListTile(
                                                            title: Text(item.color == null || item.color!.isEmpty ? " " : item.color.toString(),
                                                                style: cairoBold),
                                                            subtitle: Row(
                                                              children: [
                                                            ...
                                                            value: details.selectVariant != null && details.selectVariant!.id == item.id,
                                                            onChanged: (bool? value) {
                                                              if (details.selectVariant != null && details.selectVariant!.id == item.id) {
                  ...
                  Row(children: [
                    Text(getTranslated('total_price', context)!, style: cairoBold),
                      ...
                      : CustomButton(
                          ...
                          onTap: () async {
                            if (details.selectVariant != null) {
                              int? check =
                                  await Provider.of<CartProvider>(context, listen: false).isAddedInCart(widget.product.id, details.selectVariant!.id);
                              if (check == -1) {
                                ItemsCartModel cart = ItemsCartModel(
                                  ...
                                  widget.product.title,
                                  widget.product.titleEn,
                                  double.parse(details.selectVariant!.price ?? "0.0"),
                                  details.quantity,
                                  int.parse(details.selectVariant!.qnt!.isEmpty ? "0" : details.selectVariant!.qnt ?? "0"),
                              ...
                              showCustomSnackBar(getTranslated('must_choose_variants', context)!, context);
                            }
                          }),
                ]);
              },
