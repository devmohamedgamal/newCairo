...
class OnBoardingScreen extends StatelessWidget {
  ...
  OnBoardingScreen({this.indicatorColor = Colors.grey,
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(onBoardingList.onBoardingList[index].title, style: cairoBold.copyWith(fontSize: _height*0.035), textAlign: TextAlign.center),
                            Text(onBoardingList.onBoardingList[index].description,
                                textAlign: TextAlign.center, style: cairoRegular.copyWith(
                      ...
                      child: TextButton(
                        ...
                        child: Container(
                          ...
                          child: Text(onBoardingList.selectedIndex == onBoardingList.onBoardingList.length - 1
                              ...
                              style: cairoSemiBold.copyWith(color: Colors.white, fontSize: Dimensions.FONT_SIZE_LARGE)),
                        ),
                      ),
                    ),
                  ],
