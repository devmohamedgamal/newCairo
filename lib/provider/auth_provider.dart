...
class AuthProvider with ChangeNotifier {
  ...
  Future registration(RegisterModel register,Function callback) async {
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      callback(authModel.status,register.email,register.password,authModel.massage.toString());
    }
    else {
  ...
  /// socialLogin
  Future socialLogin(SocialLoginModel socialLogin,int signWith, Function callback) async {
    _isLoading = true;
    notifyListeners();
